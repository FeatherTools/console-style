# <img src="https://github.com/FeatherTools/.github/blob/main/profile/feather-logo-200.png" alt="FeatherTools Logo" width="100" height="100"> Console style
...
## Installation
```sh
paket add Feather.ConsoleStyle
```
